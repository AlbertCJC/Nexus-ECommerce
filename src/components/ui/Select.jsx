...
const Select = forwardRef(({ label, options = [], error, className = '', id, placeholder, ...props }, ref) => {
  ...
  return (
    <div className="w-full">
      ...
      <select ref={ref} id={selectId} className={`select ${error ? 'border-[rgb(var(--accent-danger))] focus:ring-[rgb(var(--accent-danger))]' : ''} ${className}`} {...props} aria-invalid={error ? 'true' : 'false'}>
